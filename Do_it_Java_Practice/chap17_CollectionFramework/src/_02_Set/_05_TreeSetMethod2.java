...
class MyComparableClass implements Comparable<MyComparableClass> {
    ...
    @Override
    public int compareTo(MyComparableClass o) { // 크기 비교의 기준을 여기서 설정 (음수, 0, 양수)
...
public class _05_TreeSetMethod2 {
...
//      System.out.println(treeSet3.toString()); // ClassCastException
        ...
        for (MyClass myClass : treeSet5) {
            System.out.println(myClass.data1);
        }
        System.out.println(treeSet5.toString());
