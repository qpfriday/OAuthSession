...
public class _05_TreeMapMethod1 {
    public static void main(String[] args) {
        ...
        System.out.println(treeMap.toString()); // {4=4번째 데이터, ... , 20=20번째 데이터}

        // #8. pollLastEntry()
        System.out.println(treeMap.pollLastEntry()); // 20=20번째 데이터
        System.out.println(treeMap.toString()); // {4=4번째 데이터, ... , 18=18번째 데이터}
        ...
        // #13. SortedMap<K, V> subMap(K toKey)
        sortedMap = treeMap.subMap(6, 10);
        System.out.println(sortedMap); // {6=6번째 데이터, 8=8번째 데이터}

        // #14. NavigableMap<K, V> tailMap(K toKey, boolean inclusive)
        ...
        System.out.println(navigableSet.toString()); // [18, 16, ..., 6, 4]
        System.out.println(navigableSet.descendingSet()); // [4, 6, ..., 18]

        // #16. NavigableMap<K, V> descendingMap()
        navigableMap = treeMap.descendingMap();
        System.out.println(navigableMap.toString()); // {18=18번쨰 데이터, ..., 4=4번째 데이터}
