...
public class _02_CreateListObject {
    public static void main(String[] args) {
        ...
        List<Integer> aList2 = new ArrayList<>(30); // capacity = 30, size()와는 다르다

        List<Integer> aList3 = new Vector<>();
        List<Integer> aList4 = new Vector<>(30);

        List<Integer> aList5 = new LinkedList<>();
//      List<Integer> aList6 = new LinkedList<>(30); // 저장용량을 지정하는 생성자 없음

        // #방법2. Arrays 클래스의 정적 매소드 활용 (데이터의 크기를 바꿀 수 없다)
