...
public class _03_ArrayListMethod {
    public static void main(String[] args) {
        ...
        aList3.set(1, 5);
        aList3.set(3, 6);
//      aList3.set(4, 7); // IndexOutOfBound

        System.out.println(aList3); // [1, 5, 2, 6]

        // #6. remove(int index)
        aList3.remove(1); // 1번 index삭제
        ...
        // #11. get(int index)
        System.out.println("0번 째: " + aList3.get(0)); // 1
        System.out.println("1번 째: " + aList3.get(1)); // 2
        System.out.println("2번 째: " + aList3.get(2)); // 3
        for (int i = 0; i < aList3.size(); i++) {
            System.out.println(i + "번 째: " + aList3.get(i));
        }
